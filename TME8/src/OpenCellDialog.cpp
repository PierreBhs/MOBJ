...
OpenCellDialog::OpenCellDialog(QWidget* parent): QDialog(parent), lineEdit_(nullptr) {
...
bool OpenCellDialog::run(std::string& s) {
    int dialogResult = exec();
    s = getCellName().toUtf8().constData();; // cell a ouvrir
